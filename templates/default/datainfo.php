<div style="margin-bottom: 100px">
    ...
    <p class="mt-5">
        ...
        für
        die Geschäftsleitung der Gradely. Eine Nutzung der Internetseiten der Gradely ist grundsätzlich ohne jede Angabe
        personenbezogener Daten möglich. Sofern eine betroffene Person besondere Services unseres Unternehmens über
        unsere
        Internetseite in Anspruch nehmen möchte, könnte jedoch eine Verarbeitung personenbezogener Daten erforderlich
        ...
        Übereinstimmung mit den für die Gradely geltenden landesspezifischen Datenschutzbestimmungen. Mittels dieser
        ...
        <br><br>
        Die Gradely hat als für die Verarbeitung Verantwortlicher zahlreiche technische und organisatorische Maßnahmen
        ...
        frei, personenbezogene Daten auch auf alternativen Wegen, beispielsweise telefonisch, an uns zu übermitteln.
        <br><br>
        1. Begriffsbestimmungen
        Die Datenschutzerklärung der Gradely beruht auf den Begrifflichkeiten, die durch den Europäischen Richtlinien-
        und
        Verordnungsgeber beim Erlass der Datenschutz-Grundverordnung (DS-GVO) verwendet wurden. Unsere
        Datenschutzerklärung
        soll sowohl für die Öffentlichkeit als auch für unsere Kunden und Geschäftspartner einfach lesbar und
        verständlich
        ...
        <br><br>
        Gradely - Berufsbildungscenter AG
        <br>
        Bahnhöheweg 70, 3018 Bern, Schweiz
        <br>
        E-Mail: <a href="mailto:bradoa@bbcag.ch" data-toggle="tooltip" title="E-Mail schreiben">bradoa@bbcag.ch</a> & <a
                href="mailto:bbuern@bbcag.ch" data-toggle="tooltip" title="E-Mail schreiben">bbuern@bbcag.ch</a>
        <br>
        Website: http://bbuern.bbc-projects.ch/
        <br><br>
        3. Cookies
        Die Internetseiten der Gradely verwenden Cookies. Cookies sind Textdateien, welche über einen Internetbrowser
        auf
        ...
        <br><br>
        Durch den Einsatz von Cookies kann die Gradely den Nutzern dieser Internetseite nutzerfreundlichere Services
        ...
        wiederzuerkennen.
        Zweck dieser Wiedererkennung ist es, den Nutzern die Verwendung unserer Internetseite zu erleichtern. Der
        Benutzer
        ...
        abgelegten
        Cookie übernommen wird. Ein weiteres Beispiel ist das Cookie eines Warenkorbes im Online-Shop. Der Online-Shop
        merkt
        ...
        Die Internetseite der Gradely erfasst mit jedem Aufruf der Internetseite durch eine betroffene Person oder ein
        ...
        Versionen, (2) das vom zugreifenden System verwendete Betriebssystem, (3) die Internetseite, von welcher ein
        zugreifendes System auf unsere Internetseite gelangt (sogenannte Referrer), (4) die Unterwebseiten, welche über
        ein
        zugreifendes System auf unserer Internetseite angesteuert werden, (5) das Datum und die Uhrzeit eines Zugriffs
        auf
        ...
        <br><br>
        Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Gradely keine Rückschlüsse auf die
        betroffene
        Person. Diese Informationen werden vielmehr benötigt, um (1) die Inhalte unserer Internetseite korrekt
        auszuliefern,
        (2) die Inhalte unserer Internetseite sowie die Werbung für diese zu optimieren, (3) die dauerhafte
        ...
        Gradely
        daher einerseits statistisch und ferner mit dem Ziel ausgewertet, den Datenschutz und die Datensicherheit in
        unserem
        Unternehmen zu erhöhen, um letztlich ein optimales Schutzniveau für die von uns verarbeiteten personenbezogenen
        Daten sicherzustellen. Die anonymen Daten der Server-Logfiles werden getrennt von allen durch eine betroffene
        Person
        ...
        ebenfalls
        ausschließlich für eine interne Verwendung, die dem für die Verarbeitung Verantwortlichen zuzurechnen ist,
        nutzt.
        <br><br>
        ...
        Möglichkeit
        frei, die bei der Registrierung angegebenen personenbezogenen Daten jederzeit abzuändern oder vollständig aus
        dem
        ...
        für
        die Verarbeitung Verantwortliche personenbezogene Daten auf Wunsch oder Hinweis der betroffenen Person, soweit
        dem
        keine gesetzlichen Aufbewahrungspflichten entgegenstehen. Die Gesamtheit der Mitarbeiter des für die
        Verarbeitung
        ...
        Europäischen
        Richtlinien- und Verordnungsgeber oder einen anderen Gesetzgeber in Gesetzen oder Vorschriften, welchen der für
        die
        ...
        oder
        an eine internationale Organisation übermittelt wurden. Sofern dies der Fall ist, so steht der betroffenen
        Person im
        ...
        Daten,
        die bei der Gradely gespeichert sind, veranlassen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter
        des
        für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Gradely wird veranlassen, dass dem
        Löschverlangen
        unverzüglich nachgekommen wird.
        <br><br>
        Wurden die personenbezogenen Daten von der Gradely öffentlich gemacht und ist unser Unternehmen als
        Verantwortlicher
        gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten verpflichtet, so trifft die Gradely unter
        Berücksichtigung der verfügbaren Technologie und der Implementierungskosten angemessene Maßnahmen, auch
        technischer
        Art, um andere für die Datenverarbeitung Verantwortliche, welche die veröffentlichten personenbezogenen Daten
        ...
        Replikationen
        dieser personenbezogenen Daten verlangt hat, soweit die Verarbeitung nicht erforderlich ist. Der Mitarbeiter der
        Gradely wird im Einzelfall das Notwendige veranlassen.
        <br><br>
        ...
        personenbezogenen Daten, die bei der Gradely gespeichert sind, verlangen möchte, kann sie sich hierzu jederzeit
        an
        einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Gradely wird die
        ...
        auf
        der Einwilligung gemäß Art. 6 Abs. 1 Buchstabe a DS-GVO oder Art. 9 Abs. 2 Buchstabe a DS-GVO oder auf einem
        Vertrag
        ...
        Mitarbeiter der Gradely wenden.
        <br><br>
        ...
        <br><br>
        Die Gradely verarbeitet die personenbezogenen Daten im Falle des Widerspruchs nicht mehr, es sei denn, wir
        können
        ...
        Rechtsansprüchen.
        <br><br>
        Verarbeitet die Gradely personenbezogene Daten, um Direktwerbung zu betreiben, so hat die betroffene Person das
        ...
        Widerspricht
        die betroffene Person gegenüber der Gradely der Verarbeitung für Zwecke der Direktwerbung, so wird die Gradely
        die
        ...
        die
        sie betreffende Verarbeitung personenbezogener Daten, die bei der Gradely zu wissenschaftlichen oder
        historischen
        ...
        <br><br>
        Zur Ausübung des Rechts auf Widerspruch kann sich die betroffene Person direkt an jeden Mitarbeiter der Gradely
        oder
        einen anderen Mitarbeiter wenden. Der betroffenen Person steht es ferner frei, im Zusammenhang mit der Nutzung
        von
        Diensten der Informationsgesellschaft, ungeachtet der Richtlinie 2002/58/EG, ihr Widerspruchsrecht mittels
        ...
        einschließlich
        Profiling — beruhenden Entscheidung unterworfen zu werden, die ihr gegenüber rechtliche Wirkung entfaltet oder
        sie
        in ähnlicher Weise erheblich beeinträchtigt, sofern die Entscheidung (1) nicht für den Abschluss oder die
        Erfüllung
        eines Vertrags zwischen der betroffenen Person und dem Verantwortlichen erforderlich ist, oder (2) aufgrund von
        Rechtsvorschriften der Union oder der Mitgliedstaaten, denen der Verantwortliche unterliegt, zulässig ist und
        diese
        ...
        dem
        Verantwortlichen erforderlich oder (2) erfolgt sie mit ausdrücklicher Einwilligung der betroffenen Person,
        trifft
        die Gradely angemessene Maßnahmen, um die Rechte und Freiheiten sowie die berechtigten Interessen der
        betroffenen
        ...
        Leistung
        oder Gegenleistung notwendig sind, so beruht die Verarbeitung auf Art. 6 I lit. b DS-GVO. Gleiches gilt für
        solche
        ...
        Verarbeitung auf Art. 6 I lit. d DS-GVO beruhen. Letztlich könnten Verarbeitungsvorgänge auf Art. 6 I lit. f
        DS-GVO
        ...
        <br><br>
        11. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung der personenbezogenen Daten; Erforderlichkeit
        für
        ...
        Datenschutz GmbH, die als Externer Datenschutzbeauftragter Hof tätig ist, in Kooperation mit dem Anwalt für
        Datenschutzrecht Christian Solmecke erstellt.
    </p>

    <a href="/default/impressum" role="button" class="position-fixed fixed-buttonpos btn btn-secondary"
